...
namespace ai
{
    ...
    public:
        ...
        const oldstd::vector<int>& GetSubQuestIds() const;
        const oldstd::vector<int>& GetSubsequentQuestIds() const;
        const oldstd::vector<int>& GetPrecedingQuestIds() const;
        ...
        const oldstd::vector<CStr>& getActionLevels() const;
    ...
    protected:
        ...
        /* 0x0014 */ oldstd::vector<int> m_subQuestIds;
        /* 0x0024 */ ai::Quest::SubQuestCondition m_subQuestCondition;
        /* 0x0028 */ bool m_bCheckAllSubQuests;
        /* 0x0029 */ char Padding_161[3];
        /* 0x002c */ oldstd::vector<int> m_subsequentQuestIds;
        /* 0x003c */ oldstd::vector<int> m_precedingQuestIds;
        /* 0x004c */ ai::Quest::ConditionToGive m_conditionToGive;
        /* 0x0054 */ CStr m_name;
        /* 0x0060 */ CStr m_parentQuestName;
        /* 0x006c */ oldstd::vector<CStr> m_subQuestNames;
        /* 0x007c */ oldstd::vector<CStr> m_precedingQuestNames;
        ...
        /* 0x00c8 */ oldstd::vector<CStr> m_ActionLevels;
    }; /* size: 0x00d8 */
    ...
    public:
        ...
        const oldstd::set<int>* GetMutexByQuestId(int questId) const;
        void StrToQuestIdVector(const CStr& str, oldstd::vector<int>& questIds);
        CStr QuestIdVectorToStr(const oldstd::vector<int>& questIds);

    protected:
        void _Clear();
        /* 0x0004 */ oldstd::vector<ai::Quest*> m_quests;
        /* 0x0014 */ oldstd::vector<oldstd::set<int>> m_mutexes;
    }; /* size: 0x0024 */
