...
public:
	...
	typedef _OLDSTD pair<const _Kty, _Ty> value_type;
	...
	class value_compare
		: public _OLDSTD binary_function<value_type, value_type, bool>
...
template<class _Kty,
	class _Ty,
	class _Tr = hash_compare<_Kty, _OLDSTD less<_Kty> >,
	class _Alloc = _OLDSTD allocator< _OLDSTD pair<const _Kty, _Ty> > >
	class hash_map
...
template<class _Kty,
	...
	class _Tr,
	class _Alloc> inline
	void swap( _OLDSTDEXT hash_map<_Kty, _Ty, _Tr, _Alloc>& _Left,
		_OLDSTDEXT hash_map<_Kty, _Ty, _Tr, _Alloc>& _Right)
...
template<class _Kty,
	...
	class _Tr,
	class _Alloc> inline
	void swap( _OLDSTDEXT hash_multimap<_Kty, _Ty, _Tr, _Alloc>& _Left,
		_OLDSTDEXT hash_multimap<_Kty, _Ty, _Tr, _Alloc>& _Right)
...
template<class _Kty,
	class _Ty,
	class _Tr = _OLDSTDEXT hash_compare<_Kty, less<_Kty> >,
	class _Alloc = allocator< pair<const _Kty, _Ty> > >
	class _DEPRECATED hash_map
		: public _OLDSTDEXT _Hash< _OLDSTDEXT _Hmap_traits<_Kty, _Ty, _Tr, _Alloc, false> >
	{	// hash table of {key, mapped} values, unique keys
public:
	typedef hash_map<_Kty, _Ty, _Tr, _Alloc> _Myt;
	typedef _OLDSTDEXT _Hash< _OLDSTDEXT _Hmap_traits<_Kty, _Ty, _Tr, _Alloc, false> > _Mybase;
	typedef _Kty key_type;
	typedef _Ty mapped_type;
	typedef _Ty referent_type;
	typedef _Tr key_compare;
...
template<class _Kty,
	...
	class _DEPRECATED hash_multimap
		: public _OLDSTDEXT _Hash< _OLDSTDEXT _Hmap_traits<_Kty, _Ty, _Tr, _Alloc, true> >
	{	// hash table of {key, mapped} values, non-unique keys
public:
	typedef hash_multimap<_Kty, _Ty, _Tr, _Alloc> _Myt;
	typedef _OLDSTDEXT _Hash< _OLDSTDEXT _Hmap_traits<_Kty, _Ty, _Tr, _Alloc, true> > _Mybase;
	typedef _Kty key_type;
	typedef _Ty mapped_type;
	typedef _Ty referent_type;	// old name, magically gone
	typedef _Tr key_compare;
