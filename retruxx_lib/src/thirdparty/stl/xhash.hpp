...
This will work for stdext::hash_map<oldstd::string, ...
If the user is using oldstd::hash_map, we pull the specialisation into std
as well.
...
template<class _Elem,
	class _Traits,
	class _Alloc> inline
	size_t hash_value(const _OLDSTD basic_string<_Elem, _Traits, _Alloc>& _Str)
	{	// hash string to size_t value
	typedef typename _OLDSTD basic_string<_Elem, _Traits, _Alloc>::size_type _Strsize;
...
public:
	...
	typedef _OLDSTD list<typename _Traits::value_type,
	...
	typedef _OLDSTD vector<iterator,
		typename allocator_type::template
			rebind<iterator>::other> _Myvec;
	typedef _OLDSTD pair<iterator, bool> _Pairib;
	typedef _OLDSTD pair<iterator, iterator> _Pairii;
	typedef _OLDSTD pair<const_iterator, const_iterator> _Paircc;
	...
	void swap(_Myt& _Right)
		...
		if (get_allocator() == _Right.get_allocator())
			...
			oldstd::swap(_Vec, _Right._Vec);
			oldstd::swap(_Mask, _Right._Mask);
			oldstd::swap(_Maxidx, _Right._Maxidx);
