...
private:
    ...
    QuestInfoManager* m_questInfoManager = nullptr;
    RepliesManager* m_repliesManager = nullptr;
    ObjectCollection m_objectCollection;
    StringParser m_stringParser;
    LevelInfoManager* m_levelInfoManager = nullptr;
    NavPointManager* m_navPointManager = nullptr;
    WeaponGroupManager* m_weaponGroupManager = nullptr;
    SavesManager* m_savesManager = nullptr;
    MsgManager* m_msgManager = nullptr;
    HelpManager* m_helpManager = nullptr;
    bool m_bInGameMenuMode;
    std::vector<int> m_takenQuestIds;
    int m_currentTownId = -1;
    bool m_bIsHiddenByUser = false;
