...
public:
    ...
    public:
        ...
        void Invalidate();
        int SetupAsRepositoryItem(int, Belong, PointBase<int> const&);
...
public:
    ...
    Belong GetItemBelong(int) const ;
...
protected:
    ...
    int SaveGadgetsState(int, Belong, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > &);
    void OnRepositoryChanged(void *);
    bool CabinHasItems(int) const ;
    int RestoreCurValues(int, CurValues const &);
    void UpdateItemsCost();
    int ClearVehicleFromItems(int);
    int BuyCabin();
    bool IsItemRelevantForCurTradeState(ItemSaveInfo const *) const ;
    void Buy();
    int SaveVehicleItemsState(Belong, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > &);
    void ClearSaveInfo(std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > &);
    int GetVehicleId(Belong) const ;
    void UpdateOnCurTradeStateChanged();
    int TransferBasketItems(int,int);
    void FinishTrade(int);
    int RestoreTradeState();
    int BuyVehicle();
    int SaveCurValues(int, CurValues &);
    int GetBasketId(Belong) const ;
    int TransferVehicleParts(int,int,CStr const &);
    int SaveMainObject(int, Belong, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > &);
    int CalcOneItemCost(int, ai::Workshop const *, Belong) const ;
    int RestoreGadgetsState(int, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > const &);
    ...
    int SaveBasketItemsState(Belong, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > &);
    int AddItemToWorkshop(int);
    bool VehicleHasItems(int) const ;
    int RestoreVehicleItemsState(int, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > const &);
    bool RemoveItemFromWorkshop(int);
    void TransferAll(Belong, Belong);
    int SaveTradeState(bool);
    int CheckLeftItems();
    Belong GetBelongByVehicleId(int) const ;
    int TransferGadgets(int,int);
    int RestoreRepositoryItemsState(int, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > const &);
    int TransferRepositoryItems(int,int);
    void OnVehiclePartChanged(void *);
    int GetCabinId(Belong) const ;
    void UpdatePlayerItemsCostWnd(int);
    void OnGadgetChanged(void *);
    int ReplaceParentPart(CStr const &);
    int RestoreBasketItemsState(int, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > const &);
    int ClearFromVehicleParts(int,CStr const &);
    virtual int OnAfterRemoveFromWndStation();
    std::vector<CStr, std::allocator<CStr> > GetChildVehiclePartNamesByParentPart(int,CStr const &) const ;
    void UpdateTradeCostWnd(int);
    int RepairThing(int);
    int RestoreVehiclePartsState(int,CStr const &, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > const &);
    ...
    ZnayuKakProdatWnd(ZnayuKakProdatWnd const &);
    ZnayuKakProdatWnd();
    int RestoreCabinItemsState(int, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > const &);
    virtual int GameDataClear(bool);
    void UpdateWorkshopItemsCostWnd(int);
    int CheckGold(int);
    int SaveCabinItemsState(Belong, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > &);
    virtual int GameDataUpdate(void *,int);
    int MakeBottomPanel();
    int TransferCabinItems(int,int);
    virtual int GameDataSetup();
    int SaveVehiclePartsState(int,CStr const &, Belong, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > &);
    TradeType GetTradeTypeByObjectId(int) const ;
    int BuyBasket();
    int AddItem(ItemSaveInfo *, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > &);
    int SaveRepositoryItemsState(int, Belong, std::map<int, ItemSaveInfo *, std::less<int>, std::allocator<std::pair<int const , ItemSaveInfo *> > > &);
    int CalcItemsCostByBelong(Belong) const ;

public:
    RT_CLASS_DECLARE(ZnayuKakProdatWnd);
