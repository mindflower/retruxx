...
int DemoSplashWnd::OnWndNotify(m3d::ui::Wnd*, unsigned, unsigned, m3d::AIParam const&)
{
    throw std::logic_error("Not implemented");
}
...
int DemoSplashWnd::OnActivate(bool)
{
    throw std::logic_error("Not implemented");
}

int DemoSplashWnd::OnPaint(m3d::ui::DrawInfo const&)
{
    throw std::logic_error("Not implemented");
}
