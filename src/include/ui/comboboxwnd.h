...
namespace m3d
{
    namespace ui
    {
        ...
        public:
            ...
            void SetToggleButtonPane(class CStr const &,class CStr const &);
            ...
            virtual int InsertItem(class CStr const &,int);
