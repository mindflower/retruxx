...
namespace m3d
{
    namespace rend
    {
        ...
        public:
            ...
            virtual m3d::rend::VbPoolField* AddVbPoolField(m3d::rend::VbPoolField* result, m3d::rend::VertexType, unsigned int) = 0;
            ...
            virtual m3d::rend::VbHandle* GetVbStreaming(m3d::rend::VbHandle* result, m3d::rend::VertexType) = 0;
