...
namespace ai
{
    ...
    std::map<int, Gadget*, std::less<int>, std::allocator<std::pair<int const, Gadget*>>> const& Vehicle::GetGadgets() const
    {
        throw std::logic_error("Not implemented");
    }
    ...
    Vehicle::Vehicle(VehiclePrototypeInfo const& prototypeInfo) :
        ...
        m_timeOutForNextIntersectionWithWorld(0.0,0.0,10.0, -1.0),
        m_lookBox(Box::CreateObject(nullptr, CVector(1, 1, 1), nullptr)),
        m_targetBox(Box::CreateObject(nullptr, CVector(1, 1, 1), nullptr))
    {
        throw std::logic_error("Not implemented");
    }
    ...
    std::set<ref_ptr<Obstacle>, std::less<ref_ptr<Obstacle>>, std::allocator<ref_ptr<Obstacle>>> const& Vehicle::GetNearbyObstacles() const
    {
        throw std::logic_error("Not implemented");
    }
    ...
    float Vehicle::EstimateDamageFromPositionAI(CVector const&, CVector const&, std::vector<int, std::allocator<int>>) const
    {
        throw std::logic_error("Not implemented");
    }
    ...
    CVector Vehicle::_CalcRepulsionForNearbyObjects(CVector const&, CVector const&, CVector const&, CVector const&, bool, CVector&) const
    {
        throw std::logic_error("Not implemented");
    }
    ...
    CVector Vehicle::_CalcRepulsionForObstacle(Obstacle const*, CVector const&, CVector const&, CVector const&, CVector const&, bool, CVector&) const
    {
        throw std::logic_error("Not implemented");
    }
