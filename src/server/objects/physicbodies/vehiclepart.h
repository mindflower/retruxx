...
namespace ai
{
    ...
    public:
        ...
        class CStr const & GetPartName() const ;
        ...
        class CStr const & GetBlowEffectName() const ;
        unsigned int GetRepairPrice() const ;
        virtual struct m3d::Class * GetClass() const ;
        struct CVector GetSize() const ;
        virtual class CStr GetPropertyName(int) const ;
        ...
        void SetPartName(class CStr const &);
        ...
        virtual void GetPropertiesNames(class std::set<class CStr,struct std::less<class CStr>,class std::allocator<class CStr> > &) const ;
